...
class Setup {
    ...
    private function add_paths() {
        ...
        $this->set('ROOT_HREF', Util::normalize_path(isset($_SERVER["_DOCUMENT_ROOT"]) ? '/' : dirname($this->get('H5AI_HREF')), true));
        $this->set('ROOT_PATH', Util::normalize_path(isset($_SERVER["_DOCUMENT_ROOT"]) ? $_SERVER["_DOCUMENT_ROOT"] : dirname($this->get('H5AI_PATH')), false));
